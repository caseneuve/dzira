...
class TestGetIssues:
    ...
    def test_calls_private_function_and_wraps_the_result(self, mocker):
        mock_api = mocker.patch("dzira.cli.commands.api.get_sprint_issues")
...
class TestLs(CliTest):
    ...
    def test_happy_run(self, mocker):
        ...
        mock_get_sprint_and_issues = mocker.patch(
            "dzira.cli.commands.get_sprint_and_issues", Mock(return_value=sentinel.issues)
        )
    ...
    @patch("dzira.cli.commands.get_sprint_and_issues")
    ...
    def test_uses_state_option(self, mocker, state):
        ...
        mocker.patch("dzira.cli.commands.get_jira", Mock(return_value=Mock(result=sentinel.jira)))
        mock_get_sprint_and_issues = mocker.patch(
            "dzira.cli.commands.get_sprint_and_issues"
        )
    ...
    def test_supports_tabulate_formats_option(self, mocker):
        ...
        mock_issues = mocker.patch("dzira.cli.commands.get_sprint_and_issues")
        mock_show_issues = mocker.patch("dzira.cli.commands.show_issues")
...
class TestReport(CliTest):
    ...
    @patch("dzira.cli.commands.get_user")
    ...
    @patch("dzira.cli.commands.get_user", Mock())
